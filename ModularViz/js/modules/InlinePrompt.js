/**
 * InlinePrompt — canvas inline node-title input
 *
 * Shown when the user clicks the canvas in place mode.
 * Returns Promise<string|null>; null means cancelled.
 * Positioned near the click point, constrained within the viewport.
 */
...
/**
 * Show the input at viewport-relative position (sx, sy).
 * @param {number} sx  X relative to #canvas-vp top-left
 * @param {number} sy  Y relative to #canvas-vp top-left
...
export const IP = { init, show, cancel };
